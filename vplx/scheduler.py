...
class Scheduler():
    ...
    def get_linstor_data(self):
        ...
        gevent.joinall([node_data,sp_data,res_data])
        # print({'node_data':node_data.value,'res_data':res_data.value,'sp_data':sp_data.value})
        return {'node_data':node_data.value,'sp_data':sp_data.value, 'res_data':res_data.value}
